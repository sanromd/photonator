...
class PetzoldPhaseFunction(AbstractPhaseFunction):
    ...
    data_path : path to petzold_ocean.h5 (defaults to data/ at repo root)
    """
    ...
    def __init__(
        ...
        data_path = Path(data_path) if data_path else _DATA_DIR / "petzold_ocean.h5"
        data = load_hdf5_array(data_path, "petzold_ocean")  # (K, 4)
